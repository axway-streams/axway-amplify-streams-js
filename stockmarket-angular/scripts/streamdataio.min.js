 ...
 * @version v1.0.2-alpha.2
 * rev: 3185c0732cb647fb253c58d18b2ab347f6f232e9
 */
(function(b){function c(g,e,a){var b=window.location.origin;this.cancelable=this.cancelBubble=this.bubbles=!1;this.data=e||null;this.origin=b||"";this.lastEventId=a||"";this.type=g||"message"}if(!b.EventSource||b.ja){var d=(b.ja||"")+"EventSource",f=function(g,e){if(!g||"string"!=typeof g)throw new SyntaxError("Not enough arguments");this.URL=g;this.Ba(e);var a=this;setTimeout(function(){a.X()},0)};f.prototype={CONNECTING:0,OPEN:1,CLOSED:2,R:{loggingEnabled:!1,loggingPrefix:"eventsource",interval:500,
...
0<a.length&&"\ufeff"==a.substring(0,1)&&(this.cursor=1);var h=this.ra(a);h[0]>=this.cursor&&(h=h[1],this.ya(a.substring(this.cursor,h)),this.cursor=h);g.V()&&(this.log("request.isDone(). reopening the connection"),this.s(this.interval))}else this.readyState!==this.CLOSED&&(this.log("this.readyState !== this.CLOSED"),this.s(this.interval))},ya:function(g){g=this.cache+this.sa(g);g=g.split("\n\n");var a,h,b,f,d;for(a=0;a<g.length-1;a++){b="message";f=[];parts=g[a].split("\n");for(h=0;h<parts.length;h++)d=
this.Ca(parts[h]),0==d.indexOf("event")?b=d.replace(/event:?\s*/,""):0==d.indexOf("retry")?(d=parseInt(d.replace(/retry:?\s*/,"")),isNaN(d)||(this.interval=d)):0==d.indexOf("data")?f.push(d.replace(/data:?\s*/,"")):0==d.indexOf("id:")?this.lastEventId=d.replace(/id:?\s*/,""):0==d.indexOf("id")&&(this.lastEventId=null);f.length&&this.dispatchEvent(b,new c(b,f.join("\n"),this.lastEventId))}this.cache=g[g.length-1]},dispatchEvent:function(a,e){var b=this["_"+a+"Handlers"];if(b)for(var c=0;c<b.length;c++)b[c].call(this,
e);this["on"+a]&&this["on"+a].call(this,e)},addEventListener:function(a,e){this["_"+a+"Handlers"]||(this["_"+a+"Handlers"]=[]);this["_"+a+"Handlers"].push(e)},v:null,h:null,lastEventId:null,cache:"",cursor:0,readyState:0,Z:function(a,e){var b=[];if(e){var c,d,f=encodeURIComponent;for(c in e)e.hasOwnProperty(c)&&(d=f(c)+"="+f(e[c]),b.push(d))}return 0<b.length?-1==a.indexOf("?")?a+"?"+b.join("&"):a+"&"+b.join("&"):a},ra:function(a){var e=a.lastIndexOf("\n\n"),b=a.lastIndexOf("\r\r");a=a.lastIndexOf("\r\n\r\n");
return a>Math.max(e,b)?[a,a+4]:[Math.max(e,b),Math.max(e,b)+2]},Ca:function(a){return a.replace(/^(\s|\u00A0)+|(\s|\u00A0)+$/g,"")},sa:function(a){return a.replace(/\r\n|\r/g,"\n")}};if(window.XDomainRequest&&window.XMLHttpRequest&&void 0===(new XMLHttpRequest).responseType){f.isPolyfill="IE_8-9";var a=f.prototype.R;a.$=null;a.w.evs_preamble=2056;f.prototype.u=function(a){this.c=request=new XDomainRequest;request.onprogress=function(){request.L=!0;a.A()};request.onload=function(){this.H=!0;a.A()};
request.onerror=function(){this.i=!0;a.readyState=a.CLOSED;a.dispatchEvent("error",{type:"error",data:"XDomainRequest error"})};request.ontimeout=function(){this.i=!0;a.readyState=a.CLOSED;a.dispatchEvent("error",{type:"error",data:"XDomainRequest timed out"})};var e={};if(a.w){var b=a.w,c;for(c in b)b.hasOwnProperty(c)&&(e[c]=b[c]);a.lastEventId&&(e.evs_last_event_id=a.lastEventId)}request.open("GET",a.Z(a.URL,e));request.send()};f.prototype.u.prototype={c:null,L:!1,H:!1,i:!1,W:function(){return this.c.L},
V:function(){return this.c.H},U:function(){return this.c.i},T:function(){var a="";try{a=this.c.responseText||""}catch(b){}return a},abort:function(){this.c&&this.c.abort()}}}else f.isPolyfill="XHR",f.prototype.u=function(a){this.c=request=new XMLHttpRequest;a.h=this;request.onreadystatechange=function(){1<request.readyState&&a.readyState!=a.CLOSED&&(200==request.status||300<=request.status&&400>request.status?a.A():a.s(a.za))};request.onprogress=function(){};request.open("GET",a.Z(a.URL,a.w),!0);
var b=a.$,c;for(c in b)b.hasOwnProperty(c)&&request.setRequestHeader(c,b[c]);a.lastEventId&&request.setRequestHeader("Last-Event-Id",a.lastEventId);request.send()},f.prototype.u.prototype={c:null,i:!1,W:function(){return 2<=this.c.readyState},V:function(){return 4==this.c.readyState},U:function(){return this.i||400<=this.c.status},T:function(){var a="";try{a=this.c.responseText||""}catch(b){}return a},abort:function(){this.c&&this.c.abort()}};b[d]=f}})(this);var Exporter={m:function(b,c,d){c=c.split(".");for(var f=0;f<c.length-1;f++)b=b[c[f]];this.a(b,c[c.length-1],d)},a:function(b,c,d){b[c]=d}};var Logger=function(){function b(b,a){return b.replace(/{(\d+)}/g,function(b,e){var d;if(a[e]&&"object"===typeof a[e]&&a[e]instanceof Error)try{d=a[e].message,a[e].stack&&c.error(a[e].stack)}catch(f){d=a[e]}else if(a[e]&&"object"===typeof a[e])try{a[e].toString!==Object.prototype.toString?d=a[e].toString():d=JSON.stringify(a[e])}catch(f){d=a[e]}else a[e]&&"function"===typeof a[e]?d="function":d=a[e]?a[e]:b;d=""+d;return d.substring(0,Math.min(500,d.length))})}var c=window.console,d=2;return{aa:3,
