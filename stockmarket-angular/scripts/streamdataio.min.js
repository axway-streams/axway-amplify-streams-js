...
request.setRequestHeader(c,b[c]);a.lastEventId&&request.setRequestHeader("Last-Event-Id",a.lastEventId);request.send()},g.prototype.o.prototype={b:null,h:!1,W:function(){return 2<=this.b.readyState},V:function(){return 4==this.b.readyState},U:function(){return this.h||400<=this.b.status},T:function(){var a="";try{a=this.b.responseText||""}catch(b){}return a},abort:function(){this.b&&this.b.abort()}};b[d]=g}})(this);var h={g:function(b,c,d){c=c.split(".");for(var g=0;g<c.length-1;g++)b=b[c[g]];this.a(b,c[c.length-1],d)},a:function(b,c,d){b[c]=d}};var k=function(){function b(b,a){return b.replace(/{(\d+)}/g,function(b,f){var d;if(a[f]&&"object"===typeof a[f]&&a[f]instanceof Error)try{d=a[f].message,a[f].stack&&c.error(a[f].stack)}catch(g){d=a[f]}else if(a[f]&&"object"===typeof a[f])try{a[f].toString!==Object.prototype.toString?d=a[f].toString():d=JSON.stringify(a[f])}catch(n){d=a[f]}else a[f]&&"function"===typeof a[f]?d="function":d=a[f]?a[f]:b;d=""+d;return d.substring(0,Math.min(500,d.length))})}var c=window.console,d=2;return{ba:3,ca:2,
da:1,ERROR:0,Aa:function(b){d=b},debug:function(){3<=d&&c&&c.log&&c.log(b(arguments[0],Array.prototype.slice.call(arguments,1)))},info:function(){2<=d&&c&&c.info&&c.info(b(arguments[0],Array.prototype.slice.call(arguments,1)))},warn:function(){1<=d&&c&&c.warn&&c.warn(b(arguments[0],Array.prototype.slice.call(arguments,1)))},error:function(){0<=d&&c&&c.error&&c.error(b(arguments[0],Array.prototype.slice.call(arguments,1)))}}}();var l=function(b){return{c:function(b,d){if("undefined"===typeof b||null===b){if(d)throw Error(d);throw Error("value cannot be null");}return b},g:function(c,d){this.c(c,"functionName cannot be null");this.c(d,"message cannot be null");b.warn("Deprecated: function '{0}' is deprecated because '{1}'.",c,d)},na:function(b,d){if(!b){if(d)throw Error(d);throw Error("expression is not valid");}},ma:function(b,d){if(!b){if(d)throw Error(d);throw Error("expression is not valid");}}}}(k);function p(b){l.c(b,"bind cannot be null");this.ea=b;this.w=[]}p.prototype={m:function(){for(var b=this.w.slice(),c=0,d=b.length;c<d;c++)try{var g=b[c];g&&g.apply(this.ea,arguments)}catch(a){k.error("Unable to forward event: {0}",a)}},add:function(b){l.c(b,"listener cannot be null");l.na(-1==this.w.indexOf(b),"listener already exists");this.w.push(b)}};function StreamdataEventSource(b,c,d,g){l.c(b,"url cannot be null.");l.c(c,"appToken cannot be null.");l.ma(null===g||void 0===g||g.hasOwnProperty("signUrl"),"authStrategy does not implement signUrl() function.");d=d||[];g=void 0===g?null:g;var a=this;a.streamdataConfig={PROTOCOL:"https://",HOST:"streamdata.motwin.net",PORT:""};a.f=null;a.j=!1;a.B=b;a.K=new p(a);a.F=new p(a);a.L=new p(a);a.H=new p(a);a.J=new p(a);a.ka=d;a.G={type:"UnknownError",status:1E3,message:"An error occured. Please check your console logs for more details.",
source:"server"};a.open=function(){l.c(a.B,"url cannot be null");a.close();var b=a.ia(a.B,a.ka);b&&(a.f=new EventSource(b),a.f.addEventListener("open",function(b){k.debug("SSE Stream Opened to "+a.B+"event: "+JSON.stringify(b));a.j=!0;a.K.m()}),a.f.addEventListener("error",function(b){k.debug("Error with SSE at "+b+": closing the stream.");a.f.close();a.j=!1;a.H.m(a.fa(b))}),a.f.addEventListener("data",function(b){k.debug("Received data:"+b.data);a.F.m(JSON.parse(b.data))}),a.f.addEventListener("patch",
function(b){k.debug("Received patch:"+b.data);a.L.m(JSON.parse(b.data))}),a.f.addEventListener("monitor",function(b){k.debug("Received monitor:"+b.data);a.J.m(JSON.parse(b.data))}));return this};a.close=function(){a.j&&null!==a.f&&(k.info("Closing the SSE Stream."),a.f.close(),a.j=!1);return this};a.ia=function(b,d){l.c(b,"url cannot be null");d=d||[];var c=document.createElement("a");c.href=b;var m=/\/\/(.*@)/g.exec(b),m=m?m=m[1]:"",c=c.protocol+"//"+m+c.hostname+(0==c.pathname.indexOf("/")?"":"/")+
c.pathname+c.search,c=null===g?c:g.signUrl(c),m=a.ha(d),n="";0<m.length&&(n=document.createElement("a"),n.href=c,n=(-1===n.search.indexOf("?")?"?":"&")+m.join("&"));c=a.streamdataConfig.PROTOCOL+a.streamdataConfig.HOST+(a.qa(a.streamdataConfig.PORT)?"":":")+a.streamdataConfig.PORT+"/"+c+n;k.debug("converted url :"+c);return c};a.ha=function(b){b=b||[];b=a.ga(b);b.push("X-Sd-Token="+encodeURIComponent(c));return b};a.ga=function(a){a=a||[];return a.map(function(a){return"X-Sd-Header="+encodeURIComponent(a)})};
a.fa=function(b){l.c(b,"event cannot be null");var c=a.G;try{var d=JSON.parse(b.data);c.type=d.cause;c.message=d.message;c.status=d.status}catch(g){c=a.G}c.source="server";console.log(JSON.stringify(c));return new StreamdataError(c.type,c.message,c.status,c.source,!0)};a.qa=function(a){return!a||0===a.length}}
StreamdataEventSource.prototype={xa:function(b){l.c(b,"listener cannot be null");this.K.add(b);return this},va:function(b){l.c(b,"listener cannot be null");this.H.add(b);return this},ua:function(b){l.c(b,"listener cannot be null");this.F.add(b);return this},ya:function(b){l.c(b,"listener cannot be null");this.L.add(b);return this},wa:function(b){l.c(b,"listener cannot be null");this.J.add(b);return this},pa:function(){return this.j}};function StreamdataError(b,c,d,g,a){this.g=g;this.S=b;this.N=c;this.oa=a||!1;this.O=d;h.a(this,"source",this.g);h.a(this,"type",this.S);h.a(this,"message",this.N);h.a(this,"status",this.O)}StreamdataError.prototype={isFatal:function(){return this.oa},isServer:function(){return"server"==this.g},isClient:function(){return"client"==this.g},getMessage:function(){return this.N},getStatus:function(){return this.O},getType:function(){return this.S}};var streamdataio=new function(){};h.a(streamdataio,"Logger",k);h.a(k,"DEBUG",k.ba);h.a(k,"INFO",k.ca);h.a(k,"WARN",k.da);h.a(k,"ERROR",k.ERROR);h.a(k,"setLevel",k.Aa);h.a(k,"debug",k.debug);h.a(k,"info",k.info);h.a(k,"warn",k.warn);h.a(k,"error",k.error);
