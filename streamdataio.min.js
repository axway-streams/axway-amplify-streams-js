 ...
 * rev: b26640854c5faa1b58695b75e9ed7c99ccca957f
 */
...
return this};a.close=function(){a.g&&null!==a.f&&(Logger.info("Closing the SSE Stream."),a.f.close(),a.g=!1);return this};a.ia=function(b,e){Preconditions.b(b,"url cannot be null");e=e||[];var c=document.createElement("a");c.href=b;var c=c.protocol+"//"+b.substring(c.protocol.length+2,b.indexOf(c.hostname))+c.hostname+("0"!=c.port&&""!=c.port&&"80"!=c.port&&"443"!=c.port?":"+c.port:"")+(0==c.pathname.indexOf("/")?"":"/")+c.pathname+c.search,c=null===f?c:f.signUrl(c),d=a.ha(e),k="";0<d.length&&(k=
